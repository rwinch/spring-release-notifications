...
class ContentCachingRequestFilter : OncePerRequestFilter() {
    ...
    inner class ContentCachingRequestWrapper(request: HttpServletRequest) : HttpServletRequestWrapper(request) {
        ...
        override fun getInputStream(): ServletInputStream {
            ...
            return object : ServletInputStream() {
                ...
                override fun setReadListener(arg0: ReadListener) {}
            }
        }

        init {
            body = StreamUtils.copyToByteArray(request.inputStream)
        }
    }
}