...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
			.addFilterBefore(new ContentCachingRequestFilter(), ChannelProcessingFilter.class)
			.csrf().disable()
	...
	@Bean
	static GitHubServletSignature github(GithubProperties github) {
		return new GitHubServletSignature(github.getSecret());
	}
}
